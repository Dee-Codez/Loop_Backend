...
def home(background_tasks: BackgroundTasks):
    try:
        ...
        output = {"report_id":str(report_id), "file_name":f'output_{report_id}.csv',"Details":"The report is being generated in the background. To converse compute power(Limited Resources On Free Instance) the number of stores to be reported have been limited to 10. The report will be available at the get_report endpoint shortly."}
